<nav class="bg-zinc-50 py-2 shadow-dark-mild dark:bg-neutral-700">
  <div class="container mx-auto flex items-center justify-between px-4">
      <a class="flex items-center text-neutral-900 dark:text-neutral-200" href="/customer">
  ...
  <div class="hidden lg:flex lg:items-center lg:justify-between lg:px-4" id="navbarSupportedContent">
      <ul class="flex space-x-4">
          <li><a class="text-black/60 hover:text-black dark:text-white/60 dark:hover:text-white" href="/customer">Products</a></li>
          <li>
